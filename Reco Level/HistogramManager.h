...
public:
	...
	void fillHiggsHist(std::string directoryName, TLorentzVector& Dimuon, TLorentzVector& PhotonFSR1,
			TLorentzVector& PhotonFSR2, Double_t weight);
	void fillPhotonHist(std::string directoryName, TLorentzVector& FSR_Photon1_TL, TLorentzVector& FSR_Photon2_TL,
			Double_t weight);
