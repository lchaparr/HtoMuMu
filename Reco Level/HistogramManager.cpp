...
void HistogramManager::addHistogram(std::string directoryName, std::string histogramName, std::string histogramTitle, Int_t nbinsx, Double_t xlow, Double_t xup)
    {
    const char* directoryNameC = directoryName.c_str();
...
void HistogramManager::fillMuonHist(std::string directoryName, TLorentzVector& Lepton1, TLorentzVector& Lepton2, Double_t weight)
    {
...
void HistogramManager::fillHiggsHist(std::string directoryName, TLorentzVector& Dimuon, Double_t weight)
    {
...
void HistogramManager::fillHiggsHist(std::string directoryName, TLorentzVector& Dimuon, TLorentzVector& PhotonFSR, Double_t weight)
    {
...
void HistogramManager::fillHiggsHist(std::string directoryName, TLorentzVector& Dimuon, TLorentzVector& PhotonFSR1, TLorentzVector& PhotonFSR2,
	Double_t weight)
    {
...
void HistogramManager::fillPhotonHist(std::string directoryName, TLorentzVector& FSR_Photon1_TL, TLorentzVector& FSR_Photon2_TL, Double_t weight)
    {
...
void HistogramManager::fillPhotonHist(std::string directoryName, TLorentzVector& FSR_Photon1_TL, Double_t weight)
    {
    this->fillHistogram(directoryName, (char*) "PhotonEnergy_Lep1", FSR_Photon1_TL.E(), weight);
    this->fillHistogram(directoryName, (char*) "PhotonpT_Lep1", FSR_Photon1_TL.Pt(), weight);
    this->fillHistogram(directoryName, (char*) "PhotonEta_Lep1", FSR_Photon1_TL.Eta(), weight);
