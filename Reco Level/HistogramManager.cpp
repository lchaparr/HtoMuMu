...
void HistogramManager::fillMuonHist(std::string directoryName, TLorentzVector& Lepton1, TLorentzVector& Lepton2,
		Double_t weight)
{
...
void HistogramManager::fillHiggsHist(std::string directoryName, TLorentzVector& Dimuon, TLorentzVector& PhotonFSR,
		Double_t weight)
{
...
void HistogramManager::fillHiggsHist(std::string directoryName, TLorentzVector& Dimuon, TLorentzVector& PhotonFSR1,
		TLorentzVector& PhotonFSR2, Double_t weight)
{
...
void HistogramManager::fillPhotonHist(std::string directoryName, TLorentzVector& FSR_Photon1_TL,
		TLorentzVector& FSR_Photon2_TL, Double_t weight)
{
